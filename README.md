...
As demonstrated by the experiments shown in the figure above, our code is ↗️ ***4.25x*** faster than [ADer](https://github.com/zhangzjn/ADer),
a widely-used multi-class anomaly detection library, on the Nvidia A6000, and 
↗️  ***1.77x*** faster on the Nvidia RTX 4090. 
